...
public class HttpServer {
    ...
    public void start() throws IOException, URISyntaxException {
        ...
        while (running) {
            ...
            try {
                ...
                } else if (requestURI.getPath().startsWith("/component")) {
                    responseBody = callMethod(requestURI, httpMethod);
                } else {
            ...
            try (OutputStream os = clientSocket.getOutputStream()) {
                ...
                System.out.println("Error sending response body " + e.getMessage());
            }
    ...
    private byte[] callMethod(URI requestURI, String httpMethod) throws IOException {
        ...
        JsonObject response;
        try {
            response = (JsonObject) handlerMethod.invoke(null, calledServiceURI);
